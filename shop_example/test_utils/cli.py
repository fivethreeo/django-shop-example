...
DJANGO_SETTINGS_MODULE = 'shop_example.test_utils.cli' # this module
...
def configure(**extra):
    ...
    defaults = dict(
       ...
       TEMPLATE_CONTEXT_PROCESSORS = [
        ...
        SHOP_PRODUCT_MODEL = ('shop_example.shop_models.product.Product', 'shop_example'),
        SHOP_ADDRESS_MODEL = ('shop_example.shop_models.address.Address', 'shop_example'),
